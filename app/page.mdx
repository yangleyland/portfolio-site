...
**authenticity** in todays digital age. Currently building @ [Mintlify](https://mintlify.com).

## Previously

- Software Engineering Intern @ [MathWorks](https://www.mathworks.com/): Built blazingly fast and reliable inter-process pipelines in Go and C++ for the MATLAB Help Team.
...
- [Wafflr](/n/wafflr): Share life, two minutes weekly. weekly video updates with your closest friends. no filters, just real life. (<WafflrUsers />)
...
- Playing sports in general: my current rotation is surfing, golfing, and pickleball
- Mac apps ([Raycast](https://www.raycast.com/), [Obsidian](https://obsidian.md/), [Better Touch Tool](https://folivora.ai/), [Aerospace](https://github.com/nikitabobko/AeroSpace))
- Neovim, tmux, and terminals. Check out my [configs](https://github.com/yangleyland/configs)

## Stats
- <GitHubStats username="yangleyland" />
