...
- [Trojan Marketplace](https://github.com/yangleyland/Trojan-Marketplace): A platform for buying and selling items between USC students (no longer supported)
...
- Playing sports in general: my current rotation is basketball, football, pickleball, and golf
